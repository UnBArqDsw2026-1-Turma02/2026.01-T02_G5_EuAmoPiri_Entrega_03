...
const morador = new Morador //("João", "99999-9999", "email", "joao123", "senha"); Exemplo de morador
const turista = new Turista //("Maria", "88888-8888", "email", "maria123", "senha"); Exemplo de turista
