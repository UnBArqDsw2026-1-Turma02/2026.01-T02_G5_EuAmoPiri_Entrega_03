...
<figure>
  ...
  <img src="./imagensCommand/Command-Metodologia1.png" alt="Print de conversa no Discord">
...
<figure>
  ...
  <img src="./imagensCommand/Command-Metodologia2.png" alt="Print de conversa no Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord.</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 3:</strong> Envio do diagrama de Command do Discord e criação de link no draw.io.</figcaption>
  <img src="./imagensCommand/Command-Metodologia3.png" alt="Print de conversa no Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord.</em></p>
</figure>
...
<figure> <figcaption style="text-align: center"><strong>Figura 4:</strong> Diagrama Command.</figcaption> <img src="./imagensCommand/Command-DiagramaJoaoVictor.png" alt="Diagrama Command"> <p style="text-align: center"><em>Fonte: João Victor (2026).</em></p> </figure>
...
---
### Implementação do Padrão Command (Typescript)

Semelhante ao que foi preparado para a implementação do padrão em Python, também foi gravado um vídeo demonstrando o funcionamento e validação da execução do padrão em Typescript no terminal.

<font size="3"><p style="text-align: center">Vídeo 1 - Código Command Typescript.</p></font>

<iframe width="560" height="315" src="https://www.youtube.com/embed/vzGLQPGHLHM?si=mj590TZgDdO_XusO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
| 21/05/2026 | `1.1`  | Versão com python | [Samuel Lobo][Samuel] | [Gabriela Dourado][Gabriela] e [Amanda de Moura][Amanda] |
| 21/05/2026 | `1.2`  | Adição do vídeo e visão de contribuição do João Victor | [João Victor][Joao] | [Gabriela Dourado][Gabriela] e [Amanda de Moura][Amanda] |
