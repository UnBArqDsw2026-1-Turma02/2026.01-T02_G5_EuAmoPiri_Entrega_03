...
![revisao](./imagensCommand/CommandMetodologia3.png)
...
<figure> <figcaption style="text-align: center"><strong>Figura 4:</strong> Diagrama Command.</figcaption> <img src="./imagensCommand/CommandDiagramaJoaoVictor.png" alt="Diagrama Command"> <p style="text-align: center"><em>Fonte: João Victor (2026).</em></p> </figure>
