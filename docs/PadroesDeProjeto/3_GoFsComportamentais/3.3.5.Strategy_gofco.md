...
<center>Figura 1 - Discussão da solução</center>
...
<center>Figura 2 - Validação do diagrama de classes</center>
...
<center>Figura 3 - Validação final do código e execução</center>

![Figura 3: Validação final do código e execução](imagens/print3.png)

<center>Fonte: Discord</center>

5. **Revisão dos Revisores:** A revisora Mariana discorreu sobre seu ponto de vista em relação a solução que implementamos, pode-se observar na imagem a seguir

<center>Figura 4 - Revisão Mariana</center>
...
<center>Figura 5 - Diagrama da aplicação</center>

![Figura 5: Diagrama](imagens/imagem5.png)
...
<center>Figura 6 - Resultado da execução</center>
