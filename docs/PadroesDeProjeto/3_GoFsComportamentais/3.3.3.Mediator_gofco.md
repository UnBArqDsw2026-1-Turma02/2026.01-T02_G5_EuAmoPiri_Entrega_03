...
![Feedback_Anna_2](./imagens/feedback_anna_mediator2.png)

Feedback Milena:

![Feedback_Milena](./imagens/feedback_milena_mediator.png)
...
Davi: este é o rascunho da primeira versão do diagrama, elaborado após a versão 1.2 do código. Um dos grandes desafios aqui foi pensar nos relacionamentos para evitar que 2 entidades mediadas conversem entre si:

![Diagrama v1.0](./imagens/mediatorv0.drawio.png)

---

## Vídeo de demonstração do Proxy

<iframe width="1280 " height="633" src="https://youtube.com/embed/CAZ48oYJank" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---

## Visão dos contribuidores na concepção do artefato

Davi: a aula do dia 15/05 foi bem elucidativa em relação ao padrão Mediator e os exemplos (especialmente de aplicações famosas) dados pela professora em sala de aula ajudaram bastante a fixar o conceito e a enxergá-lo no trabalho. Parece ser um modelo bem financeiramente promissor se usado de maneira correta. Gostei bastante! A elaboração do diagrama foi mais complexa porque os relacionamentos têm de ser cuidadosamente pensados e explorados para centralizar no mediador e evitar com que entidades que não conversem acabem conversando entre nós.

Gabriela: Participar da construção do padrão Mediator foi excelente para compreender a transição entre organizar estruturas de código e, de fato, ditar o comportamento dinâmico de um sistema. A lógica inicial do Davi de centralizar a visualização do Local foi o ponto de partida perfeito. A partir daí, consegui evoluir a arquitetura para um intermediário abstrato que coordena eventos (como a atualização de avaliações após um novo relato e a simulação de invalidação de cache). Isso mostrou, na prática, como evitar que o nosso sistema se torne frágil e altamente acoplado.
Outro ponto fundamental dessa jornada foi a validação através da revisão técnica por pares. Ajustar a implementação para a Versão 1.2, traduzindo e acompanhar a tradução dessa comunicação isolada para o diagrama UML fechou o ciclo do meu aprendizado. Toda essa evolução garantiu uma manutenção muito mais segura para o futuro do projeto, além de uma grande robustez na nossa visão de negócio.
...
| 20/05/2026 | `1.1`  | Refatoração do GOF                                      | [Gabriela Dourado](https://github.com/gabrieladouradof)   | [Anna Clara](https://github.com/annacbrandao) e [Milena](https://github.com/milenamso)  |  
| 22/05/2026 | `1.2`  | Refatoração pós-revisão (correção de serviços) | [Gabriela Dourado](https://github.com/gabrieladouradof) |    [Davi do Egito](https://github.com/daviegito)     |  
...
|20/05/2026 | `1.2`  | Inclusão dos objetivos, metodologia e evolução para a versão 1.1  | [Gabriela Dourado](https://github.com/gabrieladouradof)              | [Davi do Egito](https://github.com/daviegito) |
|20/05/2026 | `1.3`  | Inclusão da rastreabilidade da V1.1  | [Gabriela Dourado](https://github.com/gabrieladouradof)              | [Davi do Egito](https://github.com/daviegito) |
|21/05/2026 | `1.4`  | Aumento na introdução  | [Davi do Egito](https://github.com/daviegito)              | [Gabriela Dourado](https://github.com/gabrieladouradof)              |
| 22/05/2026 | `1.5`  | Refatoração pós-revisão técnica (Adição v1.2)   | [Gabriela Dourado](https://github.com/gabrieladouradof)    |        [Davi do Egito](https://github.com/daviegito)                    |
| 22/05/2026 | `1.6`  | Acréscimo do diagrama e alguns prints adicionais   |  [Davi do Egito](https://github.com/daviegito)    |        [Gabriela Dourado](https://github.com/gabrieladouradof)              |
| 22/05/2026 | `1.7`  | Gravação e acréscimo do vídeo explicativo do padrão via Youtube   |  [Gabriela Dourado](https://github.com/gabrieladouradof)    |        [Davi do Egito](https://github.com/daviegito)              |
| 22/05/2026 | `1.8`  | Embed do YouTube consertado   | [Davi do Egito](https://github.com/daviegito)  |      [Gabriela Dourado](https://github.com/gabrieladouradof)                   |