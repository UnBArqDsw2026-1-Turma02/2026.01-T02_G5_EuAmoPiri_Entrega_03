...
<figure>
  <figcaption style="text-align: center"><strong>Figura 1:</strong> Criação do template utilizado no Draw.io.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-CriacaoLinkDrawio.png" alt="Criação do template usado no Draw.io">
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 2:</strong> Links de estudos compartilhados por Anna.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-LinksEstudosAnna.png" alt="Links de estudos compartilhados - Anna">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 3:</strong> Links de estudos compartilhados por Samuel.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-LinksEstudosSamuel.png" alt="Links de estudos - Samuel">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 4:</strong> Mensagem com o rascunho enviado por Samuel.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-MsgRascunhoSamuel.png" alt="Mensagem de Rascunho - Samuel">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 5:</strong> Mensagem com o rascunho enviado por Anna.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-MsgRascunhoAnna.png" alt="Mensagem de Rascunho - Anna">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 6:</strong> Feedback sobre o rascunho de Anna.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-FeedbackAnna.png" alt="Feedback rascunho - Anna">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 7:</strong> Discussão e feedback de Gabriela.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImpantacao-DiscussaoGabriela.png" alt="Feedback Gabriela">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 8:</strong> Discussão sobre as tecnologias a serem utilizadas.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-DiscussaoTecnologias.png" alt="Discussão Tecnologias">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 9:</strong> Compartilhamento da nova versão do diagrama por Gabriela.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-MsgVersaoGabriela.png" alt="Versão do Diagrama - Gabriela">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 10:</strong> Compartilhamento da nova versão do diagrama por Samuel.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-MsgVersaoSamuel.png" alt="Versão do Diagrama - Samuel">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 11:</strong> Feedback da revisora Mariana.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-FeedbackMariana.png" alt="Feedback Mariana">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 12:</strong> Feedback do revisor Eduardo.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-FeedbackEduardo.png" alt="Feedback Eduardo">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 13:</strong> Aviso sobre o início das revisões via GitHub.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-AvisoRevisao.png" alt="Aviso revisões">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 14:</strong> Diagrama de Implantação - EuAmoPiri (versão final da Unidade 02).</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-Final.png" alt="Diagrama de Implantação - EuAmoPiri">
  <p style="text-align: center"><em>Fonte: Autoria própria (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 15:</strong> Rascunho do diagrama elaborado por Samuel.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-RascunhoSamuel.png" alt="Rascunho de Diagrama - Samuel">
  <p style="text-align: center"><em>Fonte: Samuel (UML-DIAGRAMS, 2026).</em></p>
</figure>

2) **Rascunho feito por [Anna Clara](https://github.com/annacbrandao):**

<figure>
  <figcaption style="text-align: center"><strong>Figura 16:</strong> Rascunho do diagrama elaborado por Anna Clara.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-RascunhoAnna.jpg" alt="Rascunho de Diagrama - Anna Clara">
  <p style="text-align: center"><em>Fonte: Anna Clara (Microsoft, 2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 17:</strong> Versão 1 do diagrama, elaborada por Anna Clara.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-v1Anna.png" alt="Versão 1 do Diagrama - Anna Clara">
  <p style="text-align: center"><em>Fonte: Anna Clara (EDRAW, 2026).</em></p>
</figure>

2) **Versão 2 feita por [Gabriela](https://github.com/gabrieladouradof):**

<figure>
  <figcaption style="text-align: center"><strong>Figura 18:</strong> Versão 2 do diagrama, elaborada por Gabriela.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-v2Gabriela.png" alt="Versão 2 do Diagrama - Gabriela">
  <p style="text-align: center"><em>Fonte: Gabriela (EDRAW, 2026).</em></p>
</figure>

3) **Versão 3 feita por [Samuel](https://github.com/Samuelvlobo):**

<figure>
  <figcaption style="text-align: center"><strong>Figura 19:</strong> Versão 3 do diagrama, elaborada por Samuel.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-v3Samuel.png" alt="Versão 3 do Diagrama - Samuel">
  <p style="text-align: center"><em>Fonte: Samuel (UML-DIAGRAMS, 2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 20:</strong> Diagrama de Implantação Aprimorado - EuAmoPiri (v-aprimorada).</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-DiagramaAprimorado.png" alt="Diagrama de Implantação Aprimorado - EuAmoPiri">
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 21:</strong> Aviso sobre mudanças a serem feitas e realizadas.</figcaption>
  <img src="/assets/iniciativasExtras/DiagramaImplantacao-AvisoMelhoriaAnna.png" alt="Diagrama de Implantação Aprimorado - EuAmoPiri">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
| 19/05/2026 | `1.3.1` | Padronização das figuras do documento no formato `<figure>` com `figcaption`, fonte e numeração sequencial. Ajuste dos caminhos das imagens para `/assets/iniciativasExtras/`. | [Anna Clara][Anna] | - |
