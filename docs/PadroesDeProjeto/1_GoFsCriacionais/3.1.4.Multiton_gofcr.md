...
<figure>
  <figcaption style="text-align: center"><strong>Figura 1:</strong> Relato de dificuldade.</figcaption>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 2:</strong> Referências encontradas.</figcaption>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 3:</strong> Explicação da V1 (Anna).</figcaption>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 4:</strong> Envio do código TypeScript (Anna).</figcaption>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 5:</strong> Resultado de Execução TypeScript.</figcaption>
  <img src="/assets/Multiton-ResultadoExecucaoTypeScript.png" alt="Print de execução no terminal">
  <p style="text-align: center"><em>Fonte: Print de execução no terminal (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 6:</strong> Considerações iniciais (Samuel).</figcaption>
  <img src="/assets/Multiton-SamuelInicio.png" alt="Print conversa Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 7:</strong> Discussão sobre mudança de linguagem.</figcaption>
  <img src="/assets/Multiton-MudancaTypescriptPPython.png" alt="Print conversa Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 8:</strong> Envio do código Python (Samuel).</figcaption>
  <img src="/assets/Multiton-SamuelCodigoPython.png" alt="Print conversa Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 9:</strong> Teste no terminal (Anna).</figcaption>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 10:</strong> Resultado da execução no terminal.</figcaption>
  <img src="/assets/Multiton-ExecucaoPython.png" alt="Print de execução do terminal">
  <p style="text-align: center"><em>Fonte: Print de execução do terminal (2026).</em></p>
</figure>
...
🎥 **[Clique aqui para assistir ao vídeo de execução do código no YouTube](https://youtu.be/Qfs8Hc2VG5o)**
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 11:</strong> Diagrama Multiton - Eu Amo Piri.</figcaption>
  <img src="/assets/Multiton-DiagramaMultiton.drawio.png" alt="PNG do Diagrama">
  <p style="text-align: center"><em>Fonte: Samuel (2026).</em></p>
</figure>

Revisão [Anna Clara][Anna]:

<figure>
  <figcaption style="text-align: center"><strong>Figura 12:</strong> Envio do link do Diagrama (Samuel) e revisão (Anna).</figcaption>
  <img src="/assets/Multiton-SamuelDiagrama.png" alt="Print conversa Discord">
  <p style="text-align: center"><em>Fonte: Anna (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 13:</strong> Feedback do artefato (Davi).</figcaption>
  <img src="/assets/Multiton-Feedback1GithubDavi.png" alt="Print feedback no GitHub">
  <p style="text-align: center"><em>Fonte: Print do GitHub (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 14:</strong> Feedback do artefato (Davi).</figcaption>
  <img src="/assets/Multiton-Feedback2GithubDavi.png" alt="Print feedback no GitHub">
  <p style="text-align: center"><em>Fonte: Print do GitHub (2026).</em></p>
</figure>
...
<figure>
  <figcaption style="text-align: center"><strong>Figura 15:</strong> Feedback do artefato (João Victor).</figcaption>
  <img src="/assets/Multiton-FeedbackDiscordJoao.png" alt="Print de conversa no Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>

<figure>
  <figcaption style="text-align: center"><strong>Figura 16:</strong> Feedback do artefato após mudanças (João Victor).</figcaption>
  <img src="/assets/Multiton-Feedback2DiscordJoao.png" alt="Print feedback no Discord">
  <p style="text-align: center"><em>Fonte: Print do Discord (2026).</em></p>
</figure>
...
| 20/05/2026 | `2.0` | Adicionando vídeo de execução python. | [Ana Clara][Anna] | [Samuel Lobo][Samuel], [Davi Marques][Davi], [João Victor][Joao] |
