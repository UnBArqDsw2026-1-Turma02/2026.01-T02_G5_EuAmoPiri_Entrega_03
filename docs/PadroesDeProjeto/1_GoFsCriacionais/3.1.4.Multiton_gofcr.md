...
![Foto do resultado da execução do código](./imagens/Multiton-ResultadoExecucao.png)
...
## Evolução e Refatoração para Python

Após a elaboração do protótipo inicial em TypeScript pela integrante Anna, pode-se perceber um trabalho próximo ao **Multiton**. Depois de estudo feitos feitos principalmente na fonte abaixo:
...
Ao avaliar o código inicial, constatou-se que a estrutura lógica do TypeScript estava excelente, rodando bem. No entanto, como definimos **Python** como a tecnologia oficial do nosso back-end, decidi assumir a refatoração do código do protótipo (TypeScript) para a linguagem definitiva da aplicação (Python).
...
![Resultado da execução em Python](./imagens/resultadoRodandoPython.png)
...
Versão Samuel.
![Diagrama UML Multiton](./imagens/diagramaMultiton.png)



---

### Histórico de Decisões e Comunicação

O processo de evolução técnica, desde a concepção em TypeScript até a adoção e refatoração final em Python, foi ativamente debatido entre a equipe. O registro dessas decisões e alinhamentos metodológicos pode ser acompanhado abaixo (discussões realizadas via Discord):

![Discussão Discord 1](./imagens/dircursaoDiscord1.png)
![Discussão Discord 2](./imagens/dircursaoDiscord2.png)
![Discussão Discord 3](./imagens/dircursaoDiscord3.png)
![Discussão Discord 4](./imagens/dircursaoDiscord4.png)
![Discussão Discord 5](./imagens/dircursaoDiscord5.png)
![Discussão Discord 6](./imagens/dircursaoDiscord6.png)
...
> **Samuel:** Nessa demanda, percebi muita dificuldade para entender sobre o tema e o que especificamente precisava ser feito, mas depois com o tempo, fazendo aos poucos, acredito que deu pra compreeder melhor. Um tema difícil, mas que deu pra perceber a importancia.
> 
...
| 06/05/2026 | `1.2` | Estudos iniciais e levantamento de embasamento acadêmico. | [Samuel Lobo][Samuel]  | [Anna Clara][Anna] |
| 06/05/2026 | `1.3` | Refatoração do código-fonte de TypeScript para Python. | [Samuel Lobo][Samuel]  | [Anna Clara][Anna] |
| 06/05/2026 | `1.4` | Documentação das discussões iniciais e registro de decisões de design. | [Samuel Lobo][Samuel]  | [Anna Clara][Anna]  |
...
| 06/05/2026 | `1.6` | Atualização da evolução do artefato com refatoração para Python e histórico de decisões. | [Samuel Lobo][Samuel]  | [Anna Clara][Anna] |
