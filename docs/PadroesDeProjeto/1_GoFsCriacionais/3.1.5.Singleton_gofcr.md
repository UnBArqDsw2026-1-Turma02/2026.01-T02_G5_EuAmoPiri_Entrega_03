...
Davi: após o feedback das 2 revisoras, refinei o modelo para a devida adequação! A única coisa que não foi submetida para alteração foi a questão das cardinalidades, por se tratar de instanciação.
