...
Para a entrega do Singleton, Davi e Letícia optaram por usar Python por ser mais versátil e ter suporte a orientação a objetos, além de manter a padronização com o que já foi usado no EuAmoPiri.
...
Para que o código rode no terminal, basta copiar o código fonte de versão mais recente para um programa de edição de texto e salvá-lo com o formato .py - desta forma, outros programas vão conseguir interpretá-lo corretamente como um programa de python! 

Como recomendações dentro do terminal, existe o [nano](https://help.ubuntu.com/community/Nano), [vim](https://vim.rtorr.com/) e [nvim (neovim)](https://neovim.io/doc/user/). Para rodar o programa em um interpretador online, basta acessar algum interpretador primeiro - como o [Online Python](https://www.online-python.com/), [Programiz](https://www.programiz.com/python-programming/online-compiler/) e [OnlineGDB](https://www.onlinegdb.com/online_python_interpreter).
...
Após uma revisão da versão 1.1, foram submetidas propostas de mudanças:

Feedback da Amanda:

![Feedback da Amanda - Parte 1](./imagens/feedback_amanda1.png)
![Feedback da Amanda - Parte 2](./imagens/feedback_amanda2.png)

Feedback da Gabriela:

![Feedback da Gabriela](./imagens/feedback_gabriela.png)

Davi: com os feedbacks delas, o código agora separa adequadamente o new das inicializações, que ficam agora em _inicializar_variaveis, além de também implementar as threads pra evitar problemas com simultaneidade de acessos.
...
class ConexaoBancoPiri:
    ...
    def __new__(cls):
        if cls._instancia is None:
            with cls._lock: #dupla verificação aqui pra evitar problemas com duplicatas
                if cls._instancia is None:
                    cls._instancia = super(ConexaoBancoPiri, cls).__new__(cls)
                    cls._instancia._inicializar_variaveis()
                    print(f"criando instância única de conexão para o banco: {cls._instancia.banco}")
        return cls._instancia

    def _inicializar_variaveis(self):
        self.host = "db.euamopiri.com.br"
        self.banco = "euamopiri_prod"
        self.porta = 5432
...
if __name__ == "__main__":
    ...
    conexao_relatos = ConexaoBancoPiri.obter_instancia()
    conexao_relatos.conectar()
    conexao_relatos.executar_query("INSERT INTO relatos (turista, texto) VALUES ('Davi do Egito', 'Amei demais Piri!')")
...
![Saída da execução — Versão 1.2](./imagens/singleton_resultadov1.png)

Como as mudanças foram mais estéticas que estruturais, a saída da execução permaneceu a mesma da versão anterior, com os IDs de memória idênticos e a conexão sendo estabelecida somente 1 vez, o que implica no reaproveitamento do objeto.

#### Vídeo da execução da versão 1.2

<iframe width="560" height="315" 
src="https://www.youtube.com/embed/fvLc-PASL6w" 
...
Para melhorar até mesmo a visualização da representação do Singleton, optamos também por fazer um UML.

### Versão 1.0

Davi: usei [estes slides de inspiração](https://www.scribd.com/presentation/392669763/Java-Lecture-No7) para confecção da primeira versão do UML

![UML 1.0](./imagens/uml_1.0.png)

### Versão 1.1 - Final

Após a versão 1.0, houve o feedback das revisoras:

![feedback_revisoras](./imagens/feedback_singleton_diagrama.png)

Davi: após o feedback das 2 revisoras, refinei o modelo para a devida adequação! 

![UML 1.1](./imagens/singleton.drawio.png)

## Visão dos contribuidores na concepção do artefato

Davi: para esta entrega, gostei muito dos insights da Letícia em fazer o link desta entrega com o diagrama de pacotes da entrega passada, porque dá uma sensação de coesão e continuidade. Antes de elaborar o artefato, assisti a alguns vídeos no YouTube explicando como o Singleton funciona e de maneira geral achei o conceito tranquilo de se entender. Não que seja completamente fácil, mas definitivamente menos complicada que algumas das entregas anteriores. 
...
| 03/05/2026 | 1.1    | Evolução do código com simulação de uso real        | [Letícia Paiva](https://github.com/leticiakrpaiva)       | [Davi do Egito](https://github.com/daviegito), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)         |
| 16/05/2026 | 1.2    | Evolução do código com feedbacks        | [Davi do Egito](https://github.com/daviegito)       | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)         |
...
| 03/05/2026 | 1.3    | Mudança nos espaçamentos e deleção da versão 1.2 do artefato  | [Davi do Egito](https://github.com/daviegito)      | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)          |
| 16/05/2026 | 1.4    | Adição da versão 1.2 e mudanças propostas em feedback  | [Davi do Egito](https://github.com/daviegito)      | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)       |
| 19/05/2026 | 1.5    | Adição da versão 1.1 do diagrama | [Davi do Egito](https://github.com/daviegito)      | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)       |
| 19/05/2026 | 1.6    | Consertos pontuais | [Davi do Egito](https://github.com/daviegito)      | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)       |
| 20/05/2026 | 1.7    | Adição do vídeo de execução | [Davi do Egito](https://github.com/daviegito)      | [Letícia Paiva](https://github.com/leticiakrpaiva), [Amanda](https://github.com/AmandaaMoura) e [Gabriela](https://github.com/gabrieladouradof)       |
