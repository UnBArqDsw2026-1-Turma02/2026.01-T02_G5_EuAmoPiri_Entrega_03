...
if __name__ == "__main__":
    print("demonstraçao Singleton EuAmoPiri \n") 
...
Nesta versão, o padrão Singleton é aplicado em um cenário mais próximo da realidade do sistema. O método __new__ continua garantindo a instância única, enquanto o método obter_instancia centraliza o acesso ao objeto. Além disso, foram adicionados comportamentos que simulam uma conexão real com banco de dados:
