...
<center>Figura 1 — Envio de referências confiáveis no canal "geral" do Discord.</center>

![Print de conversa no Discord](./imagens/Composite-EnvioLinkGeral.png)

<center>Fonte: Print do Discord.</center>

<center>Figura 2 — Envio de referência confiável no canal do Composite do Discord e criação de link no draw.io.</center>

![Print de conversa no Discord](./imagens/Composite-DiscussaoInicialEnvioDeLink.png)
...
<center>Figura 3 — Diagrama Composite.</center>

![Diagrama Composite](./imagens/Composite-DiagramaAnna.png)
...
<center>Figura 4 — Explicação acerca da idealização da primeira versão do artefato (Anna Clara).</center>

![Print de conversa no Discord](./imagens/Composite-ExplicacaoVersaoDiagramaCodigoAnna.png)

<center>Fonte: Print do Discord.</center>

<center>Figura 5 — Continuação de explicação acerca da idealização da primeira versão do artefato (Anna Clara).</center>

![Print de conversa no Discord](./imagens/Composite-Explicacao2VersaoAnna.png)
...
<center>Figura 6 — Diagrama Composite.</center>

![Diagrama Composite Interação](./imagens/Composite-DiagramaJoao.png)

<center>Fonte: João Victor (2026).</center>

<center>Figura 7 — Explicação acerca da idealização da primeira versão do artefato (João Victor).</center>

![Print de conversa no Discord](./imagens/Composite-ExplicacaoVersaoJoao.png)
...
<center>Figura 8 — Execução do código no terminal (Anna Clara).</center>

![Print do VSCode](./imagens/Composite-ExecucaoTerminalAnna.png)

<center>Fonte: Print do VSCode.</center>
...
Comentário: Concordo totalmente
```

**Execução teste no terminal:**

<center>Figura 9 — Execução do código no terminal (João Victor).</center>

![Print do VSCode](./imagens/Composite-ExecucaoTerminalJoao.png)
...
<font size="3"><p style="text-align: center">Vídeo 2 - Código Composite TypeScript.</p></font>

<iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/bHhpkDUkfHI?si=euHV7HabFPOIZaV5"
...
>**Eduardo:**
><center>Figura 10 — Revisão de Eduardo sobre o artefato.</center>

![Print do Discord](./imagens/Composite-RevisaoEduardo.png)

<center>Fonte: Print do Discord (2026).</center>

>**Samuel:**
><center>Figura 10 — Revisão de Samuel sobre o artefato.</center>

![Print do Discord](./imagens/Composite-RevisaoSamuel.png)
...
> [1] GAMMA, Erich; HELM, Richard; JOHNSON, Ralph; VLISSIDES, John. **Design Patterns: Elements of Reusable Object-Oriented Software.** Addison-Wesley, 1995. Acesso em: 11 de maio de 2026.

> [2] SERRANO, Milene. **Arquitetura e Desenho de Software - Aula - GOFS Estruturais.** Acesso em: 11 de maio de 2026.

> [3] Refactoring Guru. **Composite.** Disponível em: <https://refactoring.guru/pt-br/design-patterns/composite>. Acesso em: 11 de maio de 2026.
...
| 20/05/2026 | `1.6` | Adição de vídeo de execução em Typescript. | [João Victor][Joao] | [Anna Clara][Anna], [Eduardo Ribeiro][Eduardo], [Samuel Lobo][Samuel] |
| 21/05/2026 | `1.7` | Pequenas correções. | [João Victor][Joao] | [Anna Clara][Anna], [Davi Marques][Davi] |
| 21/05/2026 | `1.8` | Mais ajustes no texto da documentação. | [Anna Clara][Anna] | [João Victor][Joao], [Davi Marques][Davi] |
| 22/05/2026 | `1.9` | Corrige caminhos de imagens | [Anna Clara][Anna] | [João Victor][Joao], [Davi Marques][Davi] |
