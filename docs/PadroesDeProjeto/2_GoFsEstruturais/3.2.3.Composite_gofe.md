...
<div align="center">
    ...
    <p><em>Figura 3 — Diagrama Composite (João Victor).</em></p>
</div>
...
Implementação do padrão de projeto estrutural **Composite** (GoF) aplicado as interações de usuário do projeto **Eu Amo Piri**.
...
#### 2.6. Classe Comentario (Interação)
...
<div align="center">
    ...
    <p><em>Figura 6 — Execução do código no terminal (João Victor) - Print do VSCode.</em></p>
</div>
