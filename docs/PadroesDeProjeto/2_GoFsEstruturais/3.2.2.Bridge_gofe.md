...
Após uma discussão de ideias, evoluimos o diagrama para chegar em um modelo final:
...
| 20/05/2026 | `1.1`  | Adição da modelagem UML, vídeo de execução e refinamento de tópicos (Evolução para Produto Oficial)  | [Samuel Rodrigues](https://github.com/samuel-rodrigues) | [Davi do Egito](https://github.com/daviegito)                                                                                     |
