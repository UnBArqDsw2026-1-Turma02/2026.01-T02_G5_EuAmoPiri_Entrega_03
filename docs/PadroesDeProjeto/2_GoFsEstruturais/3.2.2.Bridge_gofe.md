...
Como usos do Bridge, há de se citar que ele permite com que você desenvolva partes de uma aplicação independentemente umas das outras, o que ajuda a acelerar o desenvolvimento. (Refactoring Guru, 2025)
...
![Discord_discussao](./imagens/discussao_discord_bridge.png)
...
Após uma discussão de ideias, evoluimos o diagrama para chegar no modelo 1.1:

![Bridge_discussao](./imagens/discussaoUML.png)

Fonte: Print Discord(2026)

Após a revisão do Davi:
...
Para confecção final do diagrama, contamos com o feedback das revisoras:

![Feedback_Anna](./imagens/feedback_anna_bridge.png)

![Feedback_Leticia](./imagens/feedback_leticia_bridge.png)

Após os feedbacks delas, houve a formulação da versão final do diagrama:

![v1.2_bridge](./imagens/v1.3_bridge.png)
...
REFACTORING GURU. Bridge. Disponível em: https://refactoring.guru/pt-br/design-patterns/bridge. Acesso em: 22 de maio 2026.

## Histórico do artefato

| Data       | Versão | Descrição                                               | Autor                                                      | Revisores                                                                                                                         |
| ---------- | ------ | ------------------------------------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 17/05/2026 | `1.0`  | Rascunho inicial  | [Davi do Egito](https://github.com/daviegito)              |     [Samuel Rodrigues](https://github.com/samuel-rodrigues)                                                                                                                              |
| 20/05/2026 | `1.1`  | Adição da modelagem UML, vídeo de execução e refinamento de tópicos (Evolução para Produto Oficial)  | [Samuel Rodrigues](https://github.com/samuel-rodrigues) | [Davi do Egito](https://github.com/daviegito), [Anna](https://github.com/annacbrandao) e [Letícia](https://github.com/leticiakrpaiva)                                                                                     |

## Histórico do documento

| Data       | Versão | Descrição                                                      | Autor                                                      | Revisores |
| ---------- | ------ | -------------------------------------------------------------- | ---------------------------------------------------------- | --------- |
| 15/05/2026 | `1.0`  | Criação do documento inicial                                   | [Davi do Egito](https://github.com/daviegito)              |  [Samuel Rodrigues](https://github.com/samuel-rodrigues)         |
| 17/05/2026 | `1.1`  | Adição da versão 1.0 do artefato                               | [Davi do Egito](https://github.com/daviegito)              |  [Samuel Rodrigues](https://github.com/samuel-rodrigues)         |
| 20/05/2026 | `1.2`  | Atualização para versão final com modelagem e comprovação em vídeo | [Samuel Rodrigues](https://github.com/samuel-rodrigues) | [Davi do Egito](https://github.com/daviegito) |
| 20/05/2026 | `1.3`  | Pequenas correções pontuais | [Davi do Egito](https://github.com/daviegito) | [Samuel Rodrigues](https://github.com/samuel-rodrigues) |
| 21/05/2026 | `1.4`  | Adição de mais evidências | [Davi do Egito](https://github.com/daviegito) | [Samuel Rodrigues](https://github.com/samuel-rodrigues) |
| 22/05/2026 | `1.5`  | Adição da versão 1.2 do diagrama | [Davi do Egito](https://github.com/daviegito) | [Samuel Rodrigues](https://github.com/samuel-rodrigues) |